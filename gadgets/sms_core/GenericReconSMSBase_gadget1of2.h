...
namespace Gadgetron {
    ...
    template <typename T> 
    class EXPORTGADGETSSMSCORE GenericReconSMSBase_gadget1of2 : public Gadget1of2<T>
    {
    public:
    ...
    class EXPORTGADGETSSMSCORE GenericReconKSpaceReadoutBase_gadget1of2 :public GenericReconSMSBase_gadget1of2 < ISMRMRD::AcquisitionHeader >
    {
    public:
    ...
    class EXPORTGADGETSSMSCORE GenericReconDataBase_gadget1of2 :public GenericReconSMSBase_gadget1of2 < IsmrmrdReconData >
    {
    public:
    ...
    class EXPORTGADGETSSMSCORE GenericReconImageBase_gadget1of2 :public GenericReconSMSBase_gadget1of2 < IsmrmrdImageArray >
    {
    public:
    ...
    class EXPORTGADGETSSMSCORE GenericReconImageHeaderBase_gadget1of2 :public GenericReconSMSBase_gadget1of2 < ISMRMRD::ImageHeader >
    {
    public:
